...
9b. **Model deep-dive** (\`model-deep-dive\`): when FOCUS MODEL block is present, the article is a single-product editorial review — spec sheet, strengths/weaknesses, who should buy/skip, one rival section max, Final Verdict with buy/wait/skip.
