      ...
      <div className="flex flex-wrap gap-2">
        {SHARE_PLATFORMS.map((platform) => (
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-border bg-muted/40 px-3 py-2 font-sans text-xs font-medium text-foreground transition hover:border-accent/40 hover:bg-accent/10 hover:text-accent"
