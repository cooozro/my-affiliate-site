---
title: 'Window AC by Room: Studio, Nursery, and Sleep-Hot Nights in Heat Waves'
description: >-
  Scenario picks for window and through-wall air conditioners by room size,
  install limits, and sleep noise during summer heat waves.
date: '2026-07-14'
tags:
...
| Item | Source | Purpose |
| --- | --- | --- |
| Cooling capacity (BTU) | Manufacturer spec sheets | Room-size matching |
| Energy label / EER or CEER | Published product labels | Operating-cost signal |
...
| Check | Pass if… |
| --- | --- |
| Floor plan | Interior dims match OEM room table |
| Sill depth | Bracket kit listed for your sash type |
| Circuit | Dedicated 15 A circuit preferred |
...
| Check | Pass if… |
| --- | --- |
| Peak load | Room BTU table + sun exposure adders |
| Night schedule | Timer/app tested before heat-wave forecast |
| Filter | Washable filter accessible every 2 weeks |
