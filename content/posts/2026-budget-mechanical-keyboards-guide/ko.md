...
지난주 재택 화상회의 중에, 예전에 산 멤브레인 키보드 타건음이 **상대방 마이크에 그대로 실리는** 걸 듣고 바로 기계식으로 눈을 돌렸습니다. 형님 집처럼 낮에 회의·밤에 문서가 겹치면, 로고 RGB보다 **배열·핫스왑·스위치 감각**이 먼저거든요.

2026년 상반기 입문용 기계식은 **핫스왑 소켓**과 **75%·TKL 배열**이 가격대를 낮추며 대중화됐습니다. 과거 10만 원대 핫스왑이 5만 원대까지 내려오면서, 브랜드보다 **스위치(적축·청축·갈축)**, **키캡 소재**, **폼 구조**를 보는 편이 맞습니다. 박스 마케팅은 RGB 연출만 크게 넣고, 소켓 유무·키캡 재질은 작게 두는 경우가 많더군요. **가성비**는 조명 쇼가 아니라, 첫 구매 실패를 줄이는 검증 스펙입니다.

본 리포트는 제조사 공개 스펙·공식 판매가·공개 리뷰를 교차 검증해 **입문용 기계식 키보드 5종**을 비교합니다.

**형님이 직접 좁혀 본 핵심:** 타이핑 입문 → Keychron C3, 게임·가성비 → Royal Kludge RK84, 조용한 사무실 → Epomaker TH80 Pro, 최저가 체험 → Redragon K552, 커스텀 확장 → Akko 5075B.
...
표를 다시 맞춰보니, 2026년 입문 기계식 가성비는 **배열·핫스왑·스위치 감각**을 유선·무선과 TKL·75%에 맞추는 일입니다. 브랜드 RGB 스토리만 따라가면 마케팅에 산 것이 되더군요. **내 돈이면** 용도·소음부터 잠그고, 그다음 한 줄 평으로 좁히세요.
