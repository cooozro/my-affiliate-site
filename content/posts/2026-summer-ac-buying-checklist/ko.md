...
updatedAt: '2026-08-26T14:14:08.768Z'
...
가장 더운 주에 **창문 규정·배기 불가·BTU 부족**을 알게 되지 않도록, 결제 전 아래 7가지를 순서대로 보세요. 창문형·이동식 공통이고, 항목마다 **이유**와 **주의 신호**를 달아 두었습니다. 팁 하나: 바닥 면적과 창틀 폭을 먼저 재세요 — 그늘 침실 15㎡와 서향 원룸 20㎡는 광고가 둘 다 ‘원룸용’이어도 BTU 이야기가 다릅니다. 통과한 뒤에는 이동식 vs 창문형 맞대결로 모델을 좁히면 됩니다.
...
1. **바닥 면적과 층고 실측**  
   ...
   **공식 문서에 적힌 제한:** 면적 미실측 구매는 **반품·재주문 시간(1–2주)** 과 폭염 주 불쾌 체감으로 이어지는 경우가 많습니다.
...
4. **채광·층수에 맞는 BTU 보정**  
   ...
   **공식 문서에 적힌 제한:** BTU 부족은 **하루 8시간+ 풀가동 시 월 전기료 2–3만 원↑·52 dB→고속 팬** 패턴으로 체감됩니다.
...
6. **에너지라벨·계절 kWh 추정 확인**  
   ...
   **공식 문서에 적힌 제한:** 등급 미표기 최저가는 **3년 운영 시 총비용**에서 효율형 대비 불리해지는 경우가 많습니다.
...
**공식 문서에 적힌 제한:** ‘최대 BTU’ 광고보다 **창틀 키트 적합**이 맞지 않으면 반품·재설치 시간이 먼저 듭니다.
...
**공식 문서에 적힌 제한:** 키트 폭을 재기 전에 구매하면 **설치 불가·반품(1–2주)** 로 이어지는 경우가 많습니다.
...
**공식 문서에 적힌 제한:** 15㎡ 그늘 침실에 12k는 **짧은 사이클·잔여 습기**로 꿉꿉함을 남길 수 있어—**면적부터 재세요.**
