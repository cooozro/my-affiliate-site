...
updatedAt: '2026-07-27T01:05:32.780Z'
---
## 편집부 개요

> **어드민 전용 draft** — Google sitemap·RSS 미포함, 공개 블로그 URL 비활성. SEO 개선 지표 전용 리포트입니다.

- **생성 시각 (KST):** 2026년 7월 27일 월요일 오전 10:05
- **스캔 대상:** 발행 글 52 slug / 104 locale 파일
...
- **종합 준비도:** ✅ **97%** _(좋음)_
- **집계 대상:** 발행·색인 글 **46편** / 저품질 격리(noindex) **6편**
- **평균 품질 점수:** **94점** (목표 88점) · 색인 포함 전체 평균 89점
- **품질 등급:** B등급 1편 · A등급 45편
...
| A등급(75점+) 달성 | 45/46 | **98%** | ✅ | 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩 |
| 평균 품질 점수 | 94점 | **100%** | ✅ | 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩 |
| 심층 편집 분석(해석+우려) | 46/46 | **100%** | ✅ | 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩 |
| 독자적 판단·평가 기준 | 46/46 | **100%** | ✅ | 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩 |
| 1차 검증 신호(교차 검증) | 44/46 | **96%** | ✅ | 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩 |
| 충분한 분량(≥4,500자) | 46/46 | **100%** | ✅ | 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩 |
| 실모델·근거 제시 | 42/46 | **91%** | ✅ | 🟩🟩🟩🟩🟩🟩🟩🟩🟩⬜ |
| FAQ 3쌍 이상 | 46/46 | **100%** | ✅ | 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩 |
| 저가치 플래그 0건 | 40/46 | **87%** | ✅ | 🟩🟩🟩🟩🟩🟩🟩🟩🟩⬜ |
...
⚠️ **미달 지표 3건:** A등급(75점+) 달성 (98%), 1차 검증 신호(교차 검증) (96%), 저가치 플래그 0건 (87%) — 해당 글을 우선 보강하세요.
...
- **API 수집 시각 (KST):** 2026. 7. 27. 오전 10:05:32
- **속성 ID:** `54…28`
...
| 페이지 | 조회수 |
| --- | --- |
| `/en/blog/2026-budget-wireless-earbuds-top5` | 2 |
